        ...
        public List<Post> GetAll()
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = @"SELECT p.id, p.Title, p.Url, PublishDateTime, AuthorId, BlogId, FirstName, LastName, Bio, b.Title, b.Url
                                        FROM Post p
        ...
        public Post Get(int id)
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = @"SELECT p.Id AS PostId, p.Title, p.Url, p.PublishDateTime, t.Id AS TagId, t.Name
                                        FROM Post p 
        ...
        public List<Post> GetByBlog(int blogId)
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = @"SELECT  post.id, post.Title AS PostTitle, post.URL AS PostUrl, post.PublishDateTime, post.AuthorId, post.BlogId, blog.Title AS BlogTitle, blog.URL AS BlogUrl
                                        FROM Post post 
        ...
        public List<Post> GetByAuthor(int authorId)
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = @"SELECT p.id, p.Title AS PostTitle, p.URL AS PostUrl, p.PublishDateTime, p.AuthorId, p.BlogId, a.FirstName, a.LastName, a.Bio, b.Title AS BlogTitle, b.URL AS BlogUrl
                                        FROM Post p 
